// ======================================================================
// bletest1.v generated from TopDesign.cysch
// 10/13/2020 at 07:36
...
module BLE_v3_64_2 (
	...
	cy_clock_v1_0
		#(.id("afe3cc72-c511-4676-acec-82a705c6f7bb/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__Acc_Int_Pin_net;
	wire [0:0] tmpIO_0__Acc_Int_Pin_net;
	electrical [0:0] tmpSIOVREF__Acc_Int_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Acc_Int_Pin
		 (.oe(tmpOE__Acc_Int_Pin_net),
		  .y({1'b0}),
		  .fb({Net_70}),
		  .io({tmpIO_0__Acc_Int_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Acc_Int_Pin_net),
		  .interrupt({Net_165}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Acc_Int_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
