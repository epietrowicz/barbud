...
#define CYBLE_DOUBLECLICK_SERVICE_INDEX   (0x00u) /* Index of doubleClick service in the cyBle_customs array */
#define CYBLE_DOUBLECLICK_CLICK_CHAR_INDEX   (0x00u) /* Index of Click characteristic */
#define CYBLE_DOUBLECLICK_CLICK_CLICKCCCD_DESC_INDEX   (0x00u) /* Index of ClickCCCD descriptor */

#define CYBLE_TIMERSERVICE_SERVICE_INDEX   (0x01u) /* Index of timerService service in the cyBle_customs array */
#define CYBLE_TIMERSERVICE_TIMER_CHAR_INDEX   (0x00u) /* Index of Timer characteristic */
#define CYBLE_TIMERSERVICE_TIMER_TIMERCCCD_DESC_INDEX   (0x00u) /* Index of TimerCCCD descriptor */


#define CYBLE_DOUBLECLICK_SERVICE_HANDLE   (0x0010u) /* Handle of doubleClick service */
#define CYBLE_DOUBLECLICK_CLICK_DECL_HANDLE   (0x0011u) /* Handle of Click characteristic declaration */
#define CYBLE_DOUBLECLICK_CLICK_CHAR_HANDLE   (0x0012u) /* Handle of Click characteristic */
#define CYBLE_DOUBLECLICK_CLICK_CLICKCCCD_DESC_HANDLE   (0x0013u) /* Handle of ClickCCCD descriptor */

#define CYBLE_TIMERSERVICE_SERVICE_HANDLE   (0x0014u) /* Handle of timerService service */
#define CYBLE_TIMERSERVICE_TIMER_DECL_HANDLE   (0x0015u) /* Handle of Timer characteristic declaration */
#define CYBLE_TIMERSERVICE_TIMER_CHAR_HANDLE   (0x0016u) /* Handle of Timer characteristic */
#define CYBLE_TIMERSERVICE_TIMER_TIMERCCCD_DESC_HANDLE   (0x0017u) /* Handle of TimerCCCD descriptor */
