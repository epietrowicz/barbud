...
/* PWM Mode */
/* Parameters */
#define Timer_1_PWM_KILL_EVENT                 (1lu)
#define Timer_1_PWM_STOP_EVENT                 (0lu)
#define Timer_1_PWM_MODE                       (5lu)
#define Timer_1_PWM_OUT_N_INVERT               (0lu)
#define Timer_1_PWM_OUT_INVERT                 (1lu)
#define Timer_1_PWM_ALIGN                      (0lu)
#define Timer_1_PWM_RUN_MODE                   (0lu)
#define Timer_1_PWM_DEAD_TIME_CYCLE            (1lu)
